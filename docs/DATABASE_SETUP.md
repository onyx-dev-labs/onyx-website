# Team Uplink - Database Setup

To enable the chat functionality, you need to apply the following database schema to your Supabase project.

## 1. Apply Schema via Supabase Dashboard

1. Go to your [Supabase Dashboard](https://supabase.com/dashboard).
2. Open the **SQL Editor**.
3. Create a new query and paste the content below.
...
create policy "Participants can update messages (status)"
...
If you want to support file uploads (Avatars, Wallpapers, Images), create a new bucket in Storage:

1. Go to **Storage**.
2. Create a new bucket named `chat-assets`.
3. Set it to **Public**.
4. Add a policy to allow authenticated users to upload/insert.
